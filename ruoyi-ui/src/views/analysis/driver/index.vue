<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['analysis:driver:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['analysis:driver:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['analysis:driver:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleImport"
          v-hasPermi="['analysis:driver:import']"
        >导入</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['analysis:driver:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="driverList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="售后退款时间" align="center" prop="afterRefundsTime" />
      ...
      <el-table-column label="分拣开始时间" align="center" prop="sorterStartTime" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="售后申请时间" prop="afterSalesTime">
          <el-input v-model="form.afterSalesTime" placeholder="请输入售后申请时间" />
        </el-form-item>
        <el-form-item label="售后退款时间" prop="afterRefundsTime">
          <el-input v-model="form.afterRefundsTime" placeholder="请输入售后退款时间" />
        </el-form-item>
        ...
        <el-form-item label="分拣开始时间" prop="sorterStartTime">
          <el-input v-model="form.sorterStartTime" placeholder="请输入分拣开始时间" />
        </el-form-item>
...
<script>
import { listDriver, getDriver, delDriver, addDriver, updateDriver, exportDriver } from "@/api/analysis/driver";
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "analysis/driver/importData"
      },
      // 查询参数
      queryParams: {
        pageNum: 1,
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除司机售后报表编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有司机售后报表数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
